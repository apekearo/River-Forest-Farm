$(document).ready(function () {
    ...
    function initializeRows() {
      ...
      var postsToAdd = [];
        ...
        postsToAdd.push(createNewRow(posts[0]));
    ...
    function createNewRow(post) {
      ...
      var newPostTitle = $("<h2>");
    //   adding a class to underline the title on the front page of the site
      newPostTitle.addClass("blogTitle")
      ...
      var newPostBody = $("<h4>");
      newPostTitle.text(post.title + " ").append('<br/>');
